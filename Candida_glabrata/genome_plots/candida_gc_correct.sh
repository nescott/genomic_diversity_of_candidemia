...
ref=cgd_s05m03r02  # short ID
bam_file=bam.files  # a text file of bam files with path if necessary, to iterate over as array
gc_dir=/scratch.global/scot0854/cglabrata/ # with trailing slash, for output of GC-corrected BAMs, consider using /scratch.global/UMN_ID/
genome_size=12746276
ref2bit=/home/selmecki/scot0854/bin/faToTwoBit/Cglabrata_s05m03r02.2bit
